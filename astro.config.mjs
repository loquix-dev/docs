			...
			sidebar: [
				...
				},
				{
					...
					items: [
						...
						{ label: 'Attachment Panel', slug: 'components/attachment-panel' },
						...
						{ label: 'Feedback Form', slug: 'components/feedback-form' },
						{ label: 'Correction Input', slug: 'components/correction-input' },
						...
						{ label: 'Dropdown Select', slug: 'components/dropdown-select' },
						{ label: 'Parameter Panel', slug: 'components/parameter-panel' },
						{ label: 'Filter Bar', slug: 'components/filter-bar' },
						{ label: 'Template Card', slug: 'components/template-card' },
						{ label: 'Template Picker', slug: 'components/template-picker' },
						{ label: 'Example Gallery', slug: 'components/example-gallery' },
						{ label: 'Nudge Banner', slug: 'components/nudge-banner' },
						{ label: 'Scroll Anchor', slug: 'components/scroll-anchor' },
					],
				},
				{
					label: 'Resources',
