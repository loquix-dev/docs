...
- **Cancellation** — abort, pause, and resume, wired to a single `AbortController` per request.
- **Timeouts** — a default 60-second limit on how long it waits for your provider's stream to start.
