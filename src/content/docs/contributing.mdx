...
<Aside type="caution">
	This site currently targets `@loquix/core` 0.6.0. Do not document unreleased API unless the pull request also updates the pinned dependency and clearly identifies the new target version.
</Aside>
