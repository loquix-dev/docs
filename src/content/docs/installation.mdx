...
banner:
  content: 'These examples target <strong>@loquix/core 0.4.1</strong>.'
---
...
<Tabs syncKey="package-manager">
	...
	```sh
	pnpm add @loquix/core@0.4.1 lit
	```
	...
	```sh
	yarn add @loquix/core@0.4.1 lit
	```
...
<link
  rel="stylesheet"
  href="https://unpkg.com/@loquix/core@0.4.1/src/tokens/variables.css"
/>
<script src="https://unpkg.com/@loquix/core@0.4.1/cdn/loquix.min.js"></script>
```
