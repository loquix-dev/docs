...
<link
  rel="stylesheet"
  href="https://unpkg.com/@loquix/core/src/tokens/variables.css"
/>
...
Next, explore the [Chat Composer](/components/chat-composer/) reference.
